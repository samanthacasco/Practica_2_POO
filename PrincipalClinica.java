public class PrincipalClinica { 
    public static void main(String[] args) { 
        ...
        p1 = new Persona("Sara Salazar", "VET-001"); 
        p2 = new Persona("Jose Murillo", "VET-002"); 
        p3 = new Persona("Katherine Salas", "VET-003");
        
        m1 = new Mascota("Toby", "Labrador"); 
        m2 = new Mascota("Max", "Pitbul", 2020); 
        ...
        System.out.println( 
                ...
                + m1.consultaNombreVeterinario()); 
 
        System.out.println( 
                "Veterinario de " + m2.getNombre() + ": " 
                + m2.consultaNombreVeterinario()); 
 
        System.out.println( 
                "Veterinario de " + m3.getNombre() + ": " 
                + m3.consultaNombreVeterinario()); 
